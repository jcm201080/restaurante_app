...
def cargar_productos():
    ...
    productos = [
        ...
        # 🍽️ ENTRANTES
         # 🍽️ ENTRANTES
        {"nombre": "Ensaladilla rusa", "precio": 6.0, "categoria": "Entrantes", "tipo": "tapa", "descripcion": "Casera con mayonesa suave", "imagen": "ensaladilla.jpg"},
        {"nombre": "Croquetas caseras", "precio": 8.0, "categoria": "Entrantes", "tipo": "media", "descripcion": "De jamón ibérico", "imagen": "croquetas.jpg"},
        {"nombre": "Patatas bravas", "precio": 7.0, "categoria": "Entrantes", "tipo": "racion", "descripcion": "Con salsa brava y alioli", "imagen": "bravas.jpg"},
        ...
        # 🍔 HAMBURGUESAS
        {"nombre": "Hamburguesa clásica", "precio": 10.0, "categoria": "Hamburguesas", "tipo": "plato", "descripcion": "Carne, lechuga y tomate", "imagen": "burger_clasica.jpg"},
        {"nombre": "Hamburguesa BBQ", "precio": 12.0, "categoria": "Hamburguesas", "tipo": "plato", "descripcion": "Con salsa barbacoa y bacon", "imagen": "burger_bbq.jpg"},
        ...
        # 🥪 BOCADILLOS
        {"nombre": "Bocadillo de lomo", "precio": 6.5, "categoria": "Bocadillos", "tipo": "media", "descripcion": "Con pimientos", "imagen": "bocadillo_lomo.jpg"},
        ...
        # 🍟 RACIONES
        {"nombre": "Calamares fritos", "precio": 10.0, "categoria": "Raciones", "tipo": "racion", "descripcion": "Rebozado crujiente", "imagen": "calamares.jpg"},
        ...
        {"nombre": "Costillas BBQ", "precio": 13.0, "categoria": "Raciones", "tipo": "racion", "descripcion": "A baja temperatura"},
         ...
         # 🍰 POSTRES
        {"nombre": "Tarta de queso", "precio": 5.0, "categoria": "Postres", "tipo": "plato", "descripcion": "Cremosa al horno", "imagen": "tarta_queso.jpg"},
